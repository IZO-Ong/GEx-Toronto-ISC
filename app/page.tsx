...
export default function Page() {
  const gallery: GalleryItem[] = [
    ...
    { src: "/images/citynotice.jpg", alt: "City Notice for High-rise", caption: "A high-rise redevelopment notice in Little Jamaica is met with vandalised comments — ‘Knock this down when they haven’t started building across the street in almost 4 years?!’", className: "mt-370" },
    { src: "/images/forrent.jpg", alt: "For Rent Signs outside Store", caption: "For rent sign placed outside of the store ‘Caribbean Slice’, a Black-owned business", className: "mt-43" },
       ...
       {/* === START OF ARTICLE BODY === */}
        ...
        <section id="acknowledgments" className="mt-12 border-t pt-8">
          ...
          <p className="mt-4 text-[0.98rem] leading-7 text-justify">
            ...
            to travel abroad and immerse myself in Toronto’s rich culture.
          </p>
